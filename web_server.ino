void web_server_setup() {  
  ...
  web_server.on("/on", handle_on);
  web_server.on("/on", handle_off);
  web_server.on("/toggle", handle_toggle);
...
void handle_on() {
  Serial.println(F("[Web server] ON requested"));
...
void handle_toggle() {
  Serial.println(F("[Web server] TOGGLE requested"));
